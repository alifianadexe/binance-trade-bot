...
# get klines
bars = client.get_historical_klines('BNBUSDT', Client.KLINE_INTERVAL_1MINUTE, "1 day ago UTC", limit=1000)
...
rsi = btalib.rsi(bnb_df.close, period=10) 
...
# conn_key = bsm.start_kline_socket('BNBUSDT', bnb_trade_history, interval=Client.KLINE_INTERVAL_30MINUTE)
# bsm.start()
